...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, tipoPet: @produto.tipoPet } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, tipoPet: @produto.tipoPet } }
